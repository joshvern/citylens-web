    ...
    <details className="group mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="grid gap-3 border-t border-slate-200 bg-slate-50 p-4 md:grid-cols-2 md:p-5 xl:grid-cols-4">
        <MethodCard
          ...
          body="Current parcel facts combine NYC PLUTO (including E-designations), ACRIS ownership, DOB project activity, LPC constraints, and available CityLens aerial-change observations. Source dates remain visible on every parcel."
        />
        <MethodCard
          icon={ShieldCheck}
        ...
        <MethodCard
          ...
          body="Administrative lots, active projects, stale ownership, zoning overlays, E-designation requirements, tenancy, and site conditions can invalidate a lead. Verify official records and professional advice before outreach or underwriting."
        />
      </div>
    </details>
  );
