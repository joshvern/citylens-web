...
export default function PrivacyPage() {
  return (
    <main className="prose prose-slate mx-auto max-w-3xl py-8">
      ...
      <p>We use infrastructure and authentication providers to operate CityLens. We do not sell account information. Aggregate Parcel Intelligence adoption counters expire after no more than 90 days. Account, security, support, and user-created workflow records may be retained longer as needed to provide the pilot and meet legal or security obligations.</p>
      <h2>Your choices</h2>
